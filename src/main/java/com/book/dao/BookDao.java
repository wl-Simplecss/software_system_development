...
public class BookDao {
    ...
    private final static String ADD_BOOK_SQL="INSERT INTO book_info VALUES(seq_book_info.nextval ,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    public int matchBook(String searchWord){
        System.out.println("match book :"+searchWord);
    ...
    public List<Book> queryBook(String sw){
        ...
        List<Book> books = jdbcTemplate.query(QUERY_BOOK_SQL, new Object[]{swcx,swcx}, new RowMapper<Book>() {
            @Override
    ...
    public int addBook(Book book){
        ...
        System.out.println("add Book"+name+ " "+author);
    ...
    public int editBook(Book book){
        ...
        System.out.println("editBook:"+name+" "+author+publish+pubdate+isbn+introduction+language+pressmark+state+classId+price+bookId);
