...
<div class="col-xs-6 col-md-offset-3" style="position: relative;top: 15%">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <form  id="readeredit" action="reader_add_do.html" >
                <div class="input-group reader-container">
                ...
                <div style="text-align: center">
                    <input type="submit" id="addBtn" value="添加" class="btn btn-success btn-sm  add-but" class="text-left">
                </div>
                <script>
